...
using UnityEngine.SceneManagement;
    ...
    public class SpawnsDamagePopups : MonoBehaviour
    {
        ...
        [SerializeField] private Color healingFontColor = Color.green;
        ...
        public void DamageDone(int damage, Vector3 position, bool isCrit)
        {
            ...
            SpawnDamagePopup(damage, screenPosition, direction, isCrit, false);
        }
        
        public void HealingDone(int healAmount, Vector3 position)
        {
            if (_mainCamera == null)
                return;
            ...
            SpawnDamagePopup(healAmount, screenPosition, direction, false, true);
        }
        
        private void SpawnDamagePopup(int damage, Vector3 position, bool direction, bool isCrit, bool isHealing)
        {
            DamageLabel damageLabel = _damageLabelPopupPool.Get();
            damageLabel.Display(damage, position, direction, isCrit, isHealing, healingFontColor);
        }
