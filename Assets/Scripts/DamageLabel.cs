...
using UnityEngine;
    public class DamageLabel : MonoBehaviour
    {
        ...
        [SerializeField] private Color normalFontColor = Color.red;
        ...
        public void Display(int damage, Vector3 objPosition, bool direction, bool isCrit, bool isHealing = false, Color? customHealingColor = null)
        {
            if (damageText == null)
                return;
            ...
            if (isHealing)
            {
                damageText.color = customHealingColor ?? healingFontColor;
